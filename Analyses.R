...
setwd("/Users/gwenoliver/Desktop/Causal Inference/Final Project/PM_COVID-updated_data")

# Rename variables

aggregate_pm_census_cdc_test_beds$medianhousevalue <- aggregate_pm_census_cdc_test_beds$median_house_value
aggregate_pm_census_cdc_test_beds$medhouseholdincome <- aggregate_pm_census_cdc_test_beds$median_household_income
aggregate_pm_census_cdc_test_beds$pct_owner_occ <- aggregate_pm_census_cdc_test_beds$owner_occupied
aggregate_pm_census_cdc_test_beds$pct_owner_occ <- aggregate_pm_census_cdc_test_beds$owner_occupied
aggregate_pm_census_cdc_test_beds$pct_blk <- aggregate_pm_census_cdc_test_beds$blk_pct
aggregate_pm_census_cdc_test_beds$hispanic <- aggregate_pm_census_cdc_test_beds$hispanic_pct
aggregate_pm_census_cdc_test_beds$hispanic <- aggregate_pm_census_cdc_test_beds$hispanic_pct
aggregate_pm_census_cdc_test_beds$education <- aggregate_pm_census_cdc_test_beds$no_grad
