...
# Download ACS data from Github
# Call ACS data (CHANGE PATH)
acs <- read.csv("final project/ACSST5Y2019/ACSST5Y2019.S2701_data_with_overlays_2021-12-03T093915.csv", header=TRUE)[-1,]
# Subset columns
...
## Gwen's text:
# data <- ifelse(aggregate_pm_census_cdc_test_beds$Face_Masks_Required_in_Public == "Yes", 1, ifelse(aggregate_pm_census_cdc_test_beds$Face_Masks_Required_in_Public == "No", 2, 0))
