...
###Outcome regression w/ covariate adjustment 
fit<-glm(data=aggregate_pm_census_cdc_test_beds, Deaths ~ pm25 + ps 
         + q_popdensity
         + poverty + log(median_house_value)
         + log(median_household_income) + owner_occupied
         + blk_pct + hispanic_pct
...
#Beta= 32.9385168   95% CI: 22.8580572, 43.018976
...
#Beta=  34.526200   95% CI: 23.0180910, 46.034308
...
# 
# print(m)
# #SMD = 49.1364 95% CI: -0.6257,  98.8986
# 
